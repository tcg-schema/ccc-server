...
class CardTemplate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "width", "height", "backgroundImage", "backgroundColor", "elements"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CardTemplate from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of CardTemplate from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "elements": [CardElement.from_dict(_item) for _item in obj.get("elements")] if obj.get("elements") is not None else None
        })
        return _obj
